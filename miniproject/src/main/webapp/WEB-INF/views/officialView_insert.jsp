...
<body>
<h2> Official Board </h2>
<div id="write">
		<h2 id="divT"></h2>
		<form method="post" action="/miniproject/board/official/insert">
			<select name="type" id="type">
				<option value="official" id="official">Official</option>
			...
			<input type="text" name="title" style="width: 330px;" placeholder="title"><br>
			<textarea id="content" rows="10" cols="45" name="content" ></textarea>
			<br>
