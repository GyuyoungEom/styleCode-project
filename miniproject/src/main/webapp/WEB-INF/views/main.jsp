		...
		<header>
			<nav>
				 ...
				 <span class="logo-name">STYLE COORDER</span></a>
			       <div class="login">
                    	<ul>
                        	<li onclick="loginToggle()"><i class="far fa-user" style="color: white; " width="10"></i></li>
							<li onclick="signupToggle()"><i class="fas fa-user-plus" style="color: white;" width="10"></i></li>
                    	</ul>
                	</div>
			</nav>
		</header>
	...
	<div class="signup-form">
        		<div class="form">
            		<div class="close" onclick="signupToggle()">&times;</div>
           			<div class="text">
                	<h1 style="color: black; ">Register Form<img src="/miniproject/resources/images/signup.png" width="50"></h1>
                	
            		</div>
            	<form name="signupform" id="signupform" method="post" class="main1" action="/miniproject/signup">
                	
                <input type = "text" name="sm_id" id="sm_id" placeholder="ID" required> <input type = "button" name="idcheck" onClick="CheckId(); return false;" value="Check ID"  id="ck"/>
				...
				<input type="text"  style="width:400px;" id="address"  name="address" />
	...
	<div class="login-form">
		<div class="form">
	 		<div class="close" onclick="loginToggle()">&times;</div>
            		<div class="text">
                			<h1 style="color: black; ">Welcome<img src="/miniproject/resources/images/signin.png" width="50"></h1>
            		</div>
			<form name="loginform" method="post" class="main1"
				action="/miniproject/login">
