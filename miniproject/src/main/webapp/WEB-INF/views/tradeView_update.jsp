...
<body>
	...
	<div id="read">
		...
		<form method="post" action="/miniproject/board/trade/update" id="update">
			...
			<i class="fas fa-map-marker-alt"></i>Location : <span id="location" name="location"><%=listOne.getLocation() %></span>
			<br>
			<br>
			<br>
			...
			<div class="btn_wrap" >
				...
				<div class="container">
					...
					<button onclick="location.href='/miniproject/board/trade/delete?id=<%=listOne.getId()%>&pgNum=${ requestScope.pgNum }'; return false;"
