...
public class ReplyController{
	...
	@ResponseBody
	public void replyget(ReplyVO vo, @PathVariable String action, HttpServletResponse response) throws ServletException, IOException{
		//System.out.println(vo.getRe_select());
		//해당 게시글의 댓글 list 나타냄
		if(action.equals("delete")) {
			rs.re_delete(vo.getRe_id(),response);
		}
